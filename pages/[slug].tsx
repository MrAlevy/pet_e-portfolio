...
import {
  generateNavElementId,
  generateSectionElementId,
  getMarkdownContent,
} from "@helpers";
...
export default function Module(props: {
  ...
  const scrollToSection = (sectionId: string) => {
    ...
    const activeNavElement = document.getElementById(
      generateNavElementId({ sectionId }),
    );
  ...
  return (
    <div className="bg-gray-100">
      <Head>
        ...
        <meta
          name="description"
          content="Learning outcomes and artefacts for the module"
        />
